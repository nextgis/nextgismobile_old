 ...
 *
 */
public class MyLocationOverlay extends SafeDrawOverlay implements IMyLocationConsumer, Snappable {
	...
	public MyLocationOverlay(Context context, IMyLocationProvider myLocationProvider, MapView mapView) {
		super(context);
		...
		mPersonBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.person);
		mDirectionArrowBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.direction_arrow);
