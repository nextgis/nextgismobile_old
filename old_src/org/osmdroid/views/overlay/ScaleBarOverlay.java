	...
	protected String scaleBarLengthText(final int meters, final boolean imperial,
		...
		if (this.imperial) {
			if (meters >= METERS_PER_STATUTE_MILE * 5) {
				return context.getString(R.string.format_distance_miles,
				...
				return context.getString(R.string.format_distance_feet,
						(int) (meters * FEET_PER_METER));
			}
		} else if (this.nautical) {
			if (meters >= METERS_PER_NAUTICAL_MILE * 5) {
				return context.getString(R.string.format_distance_nautical_miles,
			...
			if (meters >= 1000 * 5) {
				return context.getString(R.string.format_distance_kilometers,
						(meters / 1000));
			} else if (meters >= 1000 / 5) {
				return context.getString(R.string.format_distance_kilometers,
						(int) (meters / 100.0) / 10.0);
			} else {
				return context.getString(R.string.format_distance_meters, meters);
			}
		}
	}
