...
public class MapFragment extends Fragment  implements MapEventListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {		
    	...
    	if(mMap != null){
            RelativeLayout rl = (RelativeLayout)layout.findViewById(R.id.maprl);
            if(rl != null){
                rl.addView(mMap, new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT));
                addMapButtons(rl);
