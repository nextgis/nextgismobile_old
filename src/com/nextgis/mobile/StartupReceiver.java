...
public class StartupReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context arg0, Intent arg1) {
		try
		{
			...
			boolean startImmediately = prefs.getBoolean(PreferencesActivity.KEY_PREF_START_SVC_ON_STARTUP, false);
			...
			if (startImmediately)
			{
				...
				boolean startTrackService = prefs.getBoolean(PreferencesActivity.KEY_PREF_SW_TRACK_SRV, false);
				...
				boolean startDSService = prefs.getBoolean(PreferencesActivity.KEY_PREF_SW_SENDPOS_SRV, false);
				if(startDSService) {
