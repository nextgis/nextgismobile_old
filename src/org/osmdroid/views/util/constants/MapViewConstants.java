...
public interface MapViewConstants {
	...
	public static final int ANIMATION_SMOOTHNESS_LOW = 2;
	public static final int ANIMATION_SMOOTHNESS_DEFAULT = 5;
	public static final int ANIMATION_SMOOTHNESS_HIGH = 10;
